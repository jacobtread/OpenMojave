...
pub const EITM: RecordType = RecordType::from_value(b"EITM");
pub const BMDT: RecordType = RecordType::from_value(b"BMDT");
pub const ICO2: RecordType = RecordType::from_value(b"ICO2");
pub const MIC2: RecordType = RecordType::from_value(b"MIC2");
pub const BMCT: RecordType = RecordType::from_value(b"BMCT");
pub const REPL: RecordType = RecordType::from_value(b"REPL");
pub const BIPL: RecordType = RecordType::from_value(b"BIPL");
pub const ETYP: RecordType = RecordType::from_value(b"ETYP");
pub const ZNAM: RecordType = RecordType::from_value(b"ZNAM");
pub const BNAM: RecordType = RecordType::from_value(b"BNAM");
