...
pub const BPTN: RecordType = RecordType::new(b"BPTN");
pub const BPNN: RecordType = RecordType::new(b"BPNN");
pub const BPNT: RecordType = RecordType::new(b"BPNT");
pub const BPNI: RecordType = RecordType::new(b"BPNI");
pub const BPND: RecordType = RecordType::new(b"BPND");
pub const RAGA: RecordType = RecordType::new(b"RAGA");
pub const XCLC: RecordType = RecordType::new(b"XCLC");
pub const XCLL: RecordType = RecordType::new(b"XCLL");
pub const IMPF: RecordType = RecordType::new(b"IMPF");
pub const XCLW: RecordType = RecordType::new(b"XCLW");
pub const XCLR: RecordType = RecordType::new(b"XCLR");
pub const XCIM: RecordType = RecordType::new(b"XCIM");
pub const XCET: RecordType = RecordType::new(b"XCET");
pub const XCCM: RecordType = RecordType::new(b"XCCM");
pub const XCWT: RecordType = RecordType::new(b"XCWT");
pub const XCAS: RecordType = RecordType::new(b"XCAS");
